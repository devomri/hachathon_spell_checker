...
class DataAccess:
    def __init__(self):
        with open("/home/omri/Dev/Python/SpellCorrector/DataAccess/Data/data_50000.pickle", "rb") as handle:
        ...
        with open("/home/omri/Dev/Python/SpellCorrector/DataAccess/Data/dictionary_5000.pickle", "rb") as handle:
            data = pickle.load(handle)
